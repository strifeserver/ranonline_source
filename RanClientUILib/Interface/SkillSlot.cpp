...
//		GASSERT ( 0 && "???? ID ???. ??????." );
	...
	else
	{
...

		{
			...
			m_pButton_Plus = CreateButtonBlue ( "SKILL_SLOT_LEVEL_UP_2015", "SKILL_SLOT_LEVEL_UP_TEXT_POS_2015", pFont, nAlignCenterBoth, SKILL_SLOT_LEVEL_UP, "+" );	
			m_pButton_Minus = CreateButtonBlue ( "SKILL_SLOT_LEVEL_DOWN_2015", "SKILL_SLOT_LEVEL_DOWN_TEXT_POS_2015", pFont, nAlignCenterBoth, SKILL_SLOT_LEVEL_DOWN, "-" );
			m_pButton_Black = CreateControl ( "SKILL_SLOT_LEVEL_UP_BLACK_2015" );
			m_pButton_Black2 = CreateControl ( "SKILL_SLOT_LEVEL_UP_BLACK_2015_2" );
		}
	}
