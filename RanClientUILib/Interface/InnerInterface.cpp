...
#include "CSchoolWarWindow.h" //add schoolwar window - CNDev
...
void CInnerInterface::OpenVehiclePage()
{
	...
	else if ( m_pCharacterWindow->IsVisible() && m_pCharacterWindow->GetActivePage() == CHARPAGE_VEHICLE )	
	{
		...
		//CInnerInterface::GetInstance().HideGroup ( CHARACTER_WINDOW_ADD );
	}
	else
	{
		CInnerInterface::GetInstance().ShowGroupFocus( CHARACTER_WINDOW );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CInnerInterface::ADDITEMBOX_RENDER_INFO ( SNATIVEID sICONINDEX, const char* szTexture, int nIndex )
{

}
void CInnerInterface::RESETITEMBOX_RENDER_INFO ()
{

}
void CInnerInterface::ADDITEMBOXRANDOM_RENDER_INFO ( SNATIVEID sICONINDEX, const char* szTexture, int nIndex )
{

}
void CInnerInterface::RESETITEMBOXRANDOM_RENDER_INFO ()
{
}
//add school wars
