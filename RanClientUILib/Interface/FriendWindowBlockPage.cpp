...
void CFriendWindowBlockPage::CreateSubControl ()
{
	...
	m_pADD_BLOCK = CreateTextButton24 ( "FRIEND_LIST_ADD_BLOCK_BUTTON", FRIEND_LIST_ADD_BLOCK_BUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",4) );
	m_pADD_BLOCK->SetShortcutKey ( DIK_RETURN );
	m_pDEL_BLOCK = CreateTextButton24 ( "FRIEND_LIST_DEL_BLOCK_BUTTON", FRIEND_LIST_DEL_BLOCK_BUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",3) );
...
CBasicTextButton* CFriendWindowBlockPage::CreateTextButton24 ( char* szButton, UIGUID ControlID , char* szText )
{
