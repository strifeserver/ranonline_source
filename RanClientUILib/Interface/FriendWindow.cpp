...
void CFriendWindow::CreateSubControl ()
{
	...
	m_bg_white->CreateSub ( this, "FRIEND_BG_WHITE", UI_FLAG_DEFAULT );	
	m_bg_white->SetVisibleSingle ( TRUE );
	RegisterControl ( m_bg_white );
	}

	m_pNORMAL_TAB_BUTTON = CreateTextButton23 ( "FRIEND_NORMAL_TAB_BUTTON", FRIEND_NORMAL_TAB_BUTTON, (char*)ID2GAMEWORD("FRIEND_TAB_BUTTON",0) );
	m_pBLOCK_TAB_BUTTON	 = CreateTextButton23 ( "FRIEND_BLOCK_TAB_BUTTON", FRIEND_BLOCK_TAB_BUTTON, (char*)ID2GAMEWORD("FRIEND_TAB_BUTTON",1) );
...
CBasicTextButton* CFriendWindow::CreateTextButton23 ( char* szButton, UIGUID ControlID , char* szText )
{
	CBasicTextButton* pTextButton = new CBasicTextButton;
...
bool CFriendWindow::ADD_FRIEND ( const CString& strName )
{
	bool bFriend = m_pNormalPage->ADD_FRIEND ( strName );
	return bFriend;
}
