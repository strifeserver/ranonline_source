...
void CFriendWindowNormalPage::CreateSubControl ()
{
	...
	m_pADD = CreateTextButton24 ( "FRIEND_LIST_ADDBUTTON", FRIEND_LIST_ADDBUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",0) );
	m_pADD->SetShortcutKey ( DIK_RETURN );
	m_pDEL = CreateTextButton24 ( "FRIEND_LIST_DELBUTTON", FRIEND_LIST_DELBUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",1) );
	m_pMOVE = CreateTextButton24 ( "FRIEND_LIST_MOVEBUTTON", FRIEND_LIST_MOVEBUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",2) );

	m_pPARTY = CreateTextButton24 ( "FRIEND_LIST_PARTYBUTTON", FRIEND_LIST_PARTYBUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",16) );
...
#else
	m_pBLOCK = CreateTextButton24 ( "FRIEND_LIST_BLOCKBUTTON", FRIEND_LIST_BLOCKBUTTON, (char*)ID2GAMEWORD("FRIEND_BUTTON",4) );
#endif
...
CBasicTextButton* CFriendWindowNormalPage::CreateTextButton24 ( char* szButton, UIGUID ControlID , char* szText )
{
...
bool CFriendWindowNormalPage::ADD_FRIEND ( const CString& strName )
{
	if ( !strName.GetLength () ) return false;
