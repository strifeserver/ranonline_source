	...
	case HP_TEXT:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				CInnerInterface::GetInstance().SHOW_COMMON_LINEINFO ( strText, NS_UITEXTCOLOR::GOLD );
			}
		}
		break;
