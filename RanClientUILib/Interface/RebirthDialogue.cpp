...
void CRebirthDialogue::CreateSubControl ()
{
...

	{
		...
		m_bg_white->CreateSub ( this, "REBIRTH_WHITE_WINDOW", UI_FLAG_DEFAULT);	
	...
	pLineBox->CreateSub ( this, "BASIC_LINE_BOX_WAITSERVER", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	pLineBox->CreateBaseBoxWaitServer ( "REBIRTH_DIALOGUE_LINE_BOX1" );
	RegisterControl ( pLineBox );

	pLineBox = new	CBasicLineBox;
	pLineBox->CreateSub ( this, "BASIC_LINE_BOX_WAITSERVER", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	pLineBox->CreateBaseBoxWaitServer ( "REBIRTH_DIALOGUE_LINE_BOX2" );
	RegisterControl ( pLineBox );
	}
	...
	//pTextBox = CreateStaticControl ( "DIALOG_STATIC", pFont10, nTextAlign );
	//pTextBox->AddTextNoSplit ( (char*)ID2GAMEWORD ( "REBIRTH_BUTTON", 5 ) ,dwWhite);

	pTextBox = CreateStaticControl ( "DIALOG_STATIC1", pFont8Shadow, nTextAlign );
	...
	m_pBuff = CreateFlipButton ( "CHECK_BUFF", "CHECK_BUFF" , CHECK_BUFF);

	//m_pImage = CreateFlipButton ( "CHECK_BUFF1", "CHECK_BUFF1" , CHECK_BUFF1);
	m_pImage2 = CreateFlipButton ( "LOGO_SFX_BUTTON_F2", "LOGO_SFX_BUTTON_F2" ,LOGO_SFX_BUTTON_F2);
