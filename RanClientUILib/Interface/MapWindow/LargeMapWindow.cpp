...
void CLargeMapWindow::CreateSubControl()
{
	...
	m_pInfoItem = new CLargeMapWindowMobItem;
	m_pInfoItem->CreateSub(this, "MAP_WINDOW_TAP_INFO_ITEM", UI_FLAG_DEFAULT, MAP_WINDOW_TAP_INFO_ITEM );
	m_pInfoItem->CreateSubControl();
	RegisterControl( m_pInfoItem );
