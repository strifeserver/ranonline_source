					...
					if( sItemCustom.nidDISGUISE != NATIVEID_NULL() )
					{
						...
						if( dwReqCharClass )
						{
							...
							else
							{
								...
								{
									szClass+=COMMENT::CHARCLASS[CharClassToIndex(GLCC_SHAPER_M)].c_str();
								}
								if ( (dwReqCharClass&GLCC_SHAPER_W)  && (dwReqCharClass_Disguise&GLCC_SHAPER_W) )
								{
									szClass+=COMMENT::CHARCLASS[CharClassToIndex(GLCC_SHAPER_W)].c_str();
								}
							}
					...
					else
					{
						...
						if( dwReqCharClass )
						{
							...
							else
							{
								...
								if ( dwReqCharClass & GLCC_SHAPER_M)
								{
									szClass+=COMMENT::CHARCLASS[CharClassToIndex(GLCC_SHAPER_M)].c_str();
								}
								if ( dwReqCharClass & GLCC_SHAPER_W)
								{
									szClass+=COMMENT::CHARCLASS[CharClassToIndex(GLCC_SHAPER_W)].c_str();
								}
								//
