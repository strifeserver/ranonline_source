...
void SkillEditorLevelPage::UpdateSkill( DWORD	m_dwSkillLevel )
{
	...
	SetWin_Num_int ( this, IDC_EDIT_SUMTIME, m_pDummySkill->m_sSPECIAL_SKILL.dwRemainSecond );
...
BOOL SkillEditorLevelPage::InverseUpdateSkill( DWORD	m_dwSkillLevel )
{
	...
	m_pDummySkill->m_sSPECIAL_SKILL.dwRemainSecond = GetWin_Num_int ( this, IDC_EDIT_SUMTIME );
