...
//	NetMsg.dwWeather = m_pLandMan->IsWeatherActive() ? GLPeriod::GetInstance().GetWeather () : NULL;
	...
	{
		GLMSG::SNET_TOWERWARS_PREVIOUS_RECORD_FLD NetMsgTWPrevFld;
		NetMsgTWPrevFld.pTWRecord.fElapsedTime = m_pGLGaeaServer->m_pTWRecord.fElapsedTime;
		NetMsgTWPrevFld.pTWRecord.wSchool = m_pGLGaeaServer->m_pTWRecord.wSchool;
		NetMsgTWPrevFld.pTWRecord.strName = m_pGLGaeaServer->m_pTWRecord.strName;

		m_pGLGaeaServer->SENDTOCLIENT ( m_dwClientID, &NetMsgTWPrevFld );
	}
	//	���� Ư�� ����.
