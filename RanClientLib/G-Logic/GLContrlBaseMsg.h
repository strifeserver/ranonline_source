...
#include "GLRoyalRumbleDefine.h" //Add RoyalRumble Player Define- CNDev
...
enum EMCHAR_GATEOUT_FB
{
	...
	EMCHAR_GATEOUT_NOPARTY = 11,		//	Add remove party first before entering the map - CNDev (CN Dev)
};
