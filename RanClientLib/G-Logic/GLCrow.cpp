...
{
	if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERMP 
		|| m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERPHX
		||	m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERSG 
		|| m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_IGNORE_SHOCK )
		{
		}
		else
		{
