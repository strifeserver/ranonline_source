...
//#endif
	...
	m_nMyCCafeClass		= sDATA.m_nMyCCafeClass;					// �����̽þ� PC�� �̺�Ʈ
}
...
VOID SCHARDATA2::InitRebuildData() //sealed card NaJDeV
{
	CloseRebuild();
...
const SITEMCUSTOM& SCHARDATA2::GET_REBUILD_SEAL() //sealed card NaJDeV
{
	static SITEMCUSTOM sItemCustom;
	sItemCustom.sNativeID = NATIVEID_NULL();
