...
public:
	TW_PREVIOUS_RECORD		m_pTWRecord;
...
public:
	...
	BOOL		RequestViewProperties ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNET_VIEW_PROPERTIES *pNetMsg );//�d���ݩ�
	...
	BOOL	ReqTWRecordPreviousResult ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNET_TOWERWARS_PREVIOUS_RECORD* pNetMsg );
...
public:
	...
	BOOL TowerDownPHX ( GLMSG::SNET_SW_TOWERDOWN_BRD *pNetMsg );
