...
void CROWREN::SETTYPEFLAG ( GLCharacter *pMYCHAR, CItemClientDrop *pITEM )
{
	...
	switch ( pITEM_DATA->sBasicOp.emLevel )
	{
		...
		case LEVEL_VERYRARE:		{	m_dwCOLOR = NS_UITEXTCOLOR::VERYRARE;	}	break;
		case LEVEL_EPIC:			{	m_dwCOLOR = NS_UITEXTCOLOR::EPIC;		}	break;
		case LEVEL_UNIQUE:			{	m_dwCOLOR = NS_UITEXTCOLOR::UNIQUE;		}	break;
