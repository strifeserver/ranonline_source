...
HRESULT GLMapList::LoadMapList ( const TCHAR* szMapListFile, LPF_SERVER_INFO pServerInfo, int nServerNum )
{
	...
	for ( DWORD i=0; i<dwNUM; ++i )
	{
		...
		cFILE.getflag( i, "MAP_LIST", "MAP", 23, nMapKeySize, MapNode.bRRZone );	
		cFILE.getflag( i, "MAP_LIST", "MAP", 24, nMapKeySize, MapNode.bCardActivity );//Added by JADev - Anti BP, SP during CW, SW and CDM
