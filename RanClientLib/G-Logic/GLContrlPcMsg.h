...
{
	EMINVEN_BIKE_CHANGE_FB_FAIL		= 0,	//	�Ϲݿ���.
	EMINVEN_BIKE_CHANGE_FB_OK		= 1,	//	����.
	EMINVEN_BIKE_CHANGE_FB_NOITEM	= 2,	//	�������� ����.
	EMINVEN_BIKE_CHANGE_FB_BADITEM	= 3,	//	��� �Ұ��� ������.
	EMINVEN_BIKE_CHANGE_FB_BADCLASS	= 4,	//	�ɸ��� ������ Ʋ���� ��� �Ұ��� ������.
	EMINVEN_BIKE_CHANGE_FB_COOLTIME = 5,	//	��Ÿ�� ����~
};

enum EMINVEN_ITEMCOLOR_CHANGE_FB //add itemcolor
{
	EMINVEN_ITEMCOLOR_CHANGE_FB_FAIL		= 0,	//	�Ϲݿ���.
	EMINVEN_ITEMCOLOR_CHANGE_FB_OK		= 1,	//	����.
	EMINVEN_ITEMCOLOR_CHANGE_FB_NOITEM	= 2,	//	�������� ����.
	EMINVEN_ITEMCOLOR_CHANGE_FB_BADITEM	= 3,	//	��� �Ұ��� ������.
	EMINVEN_ITEMCOLOR_CHANGE_FB_BADCLASS	= 4,	//	�ɸ��� ������ Ʋ���� ��� �Ұ��� ������.
	EMINVEN_ITEMCOLOR_CHANGE_FB_COOLTIME = 5,	//	��Ÿ�� ����~
};
