...
{	
	...
	case NET_MSG_GCTRL_REQ_SERVER_ROYAL_RUMBLE_REMAIN_AG: //add royal rumble - CNDev
...
void CAgentServer::OtherMsgProcess(MSG_LIST* pMsg)
{
	...
	case NET_MSG_WPE_DT_BRD: // wpe detection - JAYDev
	case NET_MSG_AP_DT_BRD: //add autopots detection - JAYDev
