...
void CItemSuit::UpdateItems ()
{
	...
	SetWin_Num_int ( this, IDC_EDIT_ADDON_VAR6, m_pDummyItem->sSuitOp.sADDON[5].nVALUE );
	SetWin_Num_int ( this, IDC_EDIT_ADDON_VAR7, m_pDummyItem->sSuitOp.sADDON[6].nVALUE );
	SetWin_Num_int ( this, IDC_EDIT_ADDON_VAR8, m_pDummyItem->sSuitOp.sADDON[7].nVALUE );
...
bool CItemSuit::InverseUpdateItems ()
{
	...
	m_pDummyItem->sSuitOp.sADDON[5].nVALUE = GetWin_Num_int ( this, IDC_EDIT_ADDON_VAR6 );
	m_pDummyItem->sSuitOp.sADDON[6].nVALUE = GetWin_Num_int ( this, IDC_EDIT_ADDON_VAR7 );
	m_pDummyItem->sSuitOp.sADDON[7].nVALUE = GetWin_Num_int ( this, IDC_EDIT_ADDON_VAR8 );
