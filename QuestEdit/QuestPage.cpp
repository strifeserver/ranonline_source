...
void CQuestPage::UpdateItems ()
{
	...
	SetWin_Check ( this, IDC_CHECK_SHAPER_M, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_SHAPER_M) ); 
	SetWin_Check ( this, IDC_CHECK_SHAPER_W, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_SHAPER_W) );
...
void CQuestPage::InverseUpdateItems ()
{
	...
	GetWin_Check ( this, IDC_CHECK_SHAPER_M, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_SHAPER_M ); 
	GetWin_Check ( this, IDC_CHECK_SHAPER_W, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_SHAPER_W );
...
//  리소스 추가시 수정 요망  
	...
	SetWin_Enable( this, IDC_CHECK_SHAPER_M, FALSE );
	SetWin_Enable( this, IDC_CHECK_SHAPER_W, FALSE );
...
void CQuestPage::OnBnClickedRadioM()
{
	...
	SetWin_Check ( this, IDC_CHECK_SHAPER_W, false );
	...
	SetWin_Check ( this, IDC_CHECK_SHAPER_M, bCheck );
}
...
void CQuestPage::OnBnClickedRadioW()
{
	...
	SetWin_Check ( this, IDC_CHECK_SHAPER_W, bCheck );
	...
	SetWin_Check ( this, IDC_CHECK_SHAPER_M, false );
}
