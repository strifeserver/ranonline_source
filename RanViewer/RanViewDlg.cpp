...
void CRanViewDlg::OnBnClickedButtonSet2()
{
	...
	int nSelect = GetWin_Combo_Sel ( this, IDC_COMBO_ITEMEFFECT );
	int nSex = GetWin_Combo_Sel ( this, IDC_COMBO_EFF_SEX );
	...
	case 4:
		{
			switch (nSex)
			{
		//	case 0:	CRanView::GetView()->SetUpgradeEffect ( nSelect - 1 , 1 ); break;
		//	case 1:	CRanView::GetView()->SetUpgradeEffect ( nSelect - 1 , 0 ); break;
			};
		}break;
	case 5:	
		{
			for ( int i=0; i<4; ++i )
			{
				switch (nSex)
				{
		//		case 0:	CRanView::GetView()->SetUpgradeEffect ( i , 1 ); break;
		//		case 1:	CRanView::GetView()->SetUpgradeEffect ( i , 0 ); break;
				};
			}
		}break;
	};
